...
export default async function NewSubsidiaryPage({
  ...
  const initialValues: Partial<Record<SubsidiaryFormFieldKey, unknown>> = duplicateEntity
    ? {
        ...
        fiscalCalendarId: duplicateEntity.fiscalCalendarId,
        accountingStandard: duplicateEntity.accountingStandard,
        ...
        directOwnershipPercent: duplicateEntity.directOwnershipPercent != null ? String(duplicateEntity.directOwnershipPercent) : '',
        ultimateOwnershipPercent: duplicateEntity.ultimateOwnershipPercent != null ? String(duplicateEntity.ultimateOwnershipPercent) : '',
        ownershipEffectiveFrom: duplicateEntity.ownershipEffectiveFrom ? duplicateEntity.ownershipEffectiveFrom.toISOString().slice(0, 10) : '',
        ownershipEffectiveThrough: duplicateEntity.ownershipEffectiveThrough ? duplicateEntity.ownershipEffectiveThrough.toISOString().slice(0, 10) : '',
        consolidationEffectiveFrom: duplicateEntity.consolidationEffectiveFrom ? duplicateEntity.consolidationEffectiveFrom.toISOString().slice(0, 10) : '',
        consolidationEffectiveThrough: duplicateEntity.consolidationEffectiveThrough ? duplicateEntity.consolidationEffectiveThrough.toISOString().slice(0, 10) : '',
        controlIndicator: duplicateEntity.controlIndicator,
        nciRequired: duplicateEntity.nciRequired,
        eliminationTargetParentId: duplicateEntity.eliminationTargetParentId,
        eliminationScope: duplicateEntity.eliminationScope,
        eliminationCurrencyBasis: duplicateEntity.eliminationCurrencyBasis,
        ...
        investmentInSubsidiaryAccountId: duplicateEntity.investmentInSubsidiaryAccountId,
        nciEquityAccountId: duplicateEntity.nciEquityAccountId,
        nciIncomeStatementAccountId: duplicateEntity.nciIncomeStatementAccountId,
        realizedFxGainAccountId: duplicateEntity.realizedFxGainAccountId,
        realizedFxLossAccountId: duplicateEntity.realizedFxLossAccountId,
        unrealizedFxGainAccountId: duplicateEntity.unrealizedFxGainAccountId,
        unrealizedFxLossAccountId: duplicateEntity.unrealizedFxLossAccountId,
        allowTransactions: duplicateEntity.allowTransactions,
        allowBankAccounts: duplicateEntity.allowBankAccounts,
        allowInventory: duplicateEntity.allowInventory,
        allowPayroll: duplicateEntity.allowPayroll,
        allowProjects: duplicateEntity.allowProjects,
