...
export default async function NewChartOfAccountsPage({
  ...
  const initialValues: Partial<Record<ChartOfAccountsFormFieldKey, unknown>> = duplicateAccount
    ? {
        ...
        category: duplicateAccount.category,
        inventory: duplicateAccount.inventory,
        revalueOpenBalance: duplicateAccount.revalueOpenBalance,
        monetaryClassification: duplicateAccount.monetaryClassification,
        translationTreatment: duplicateAccount.translationTreatment,
        ...
        requiresMonthlyReconciliation: duplicateAccount.requiresMonthlyReconciliation,
        reconciliationType: duplicateAccount.reconciliationType,
        closeReviewOwnerId: duplicateAccount.closeReviewOwnerId,
        closeReviewFrequency: duplicateAccount.closeReviewFrequency,
        aiReviewEnabled: duplicateAccount.aiReviewEnabled,
        aiRiskLevel: duplicateAccount.aiRiskLevel,
        autoMatchStrategy: duplicateAccount.autoMatchStrategy,
        materialityThreshold: duplicateAccount.materialityThreshold?.toString(),
        agingReviewRequired: duplicateAccount.agingReviewRequired,
        reserveReviewRequired: duplicateAccount.reserveReviewRequired,
        writeOffReviewRequired: duplicateAccount.writeOffReviewRequired,
        waterfallReviewRequired: duplicateAccount.waterfallReviewRequired,
        taxSensitive: duplicateAccount.taxSensitive,
        intercompanyAccount: duplicateAccount.intercompanyAccount,
        eliminationAccount: duplicateAccount.eliminationAccount,
        bankAccountRequired: duplicateAccount.bankAccountRequired,
        inventoryCostLayerAccount: duplicateAccount.inventoryCostLayerAccount,
        revenueRecognitionAccount: duplicateAccount.revenueRecognitionAccount,
        deferredCostAccount: duplicateAccount.deferredCostAccount,
        fixedAssetAccount: duplicateAccount.fixedAssetAccount,
        prepaidAccount: duplicateAccount.prepaidAccount,
        accrualAccount: duplicateAccount.accrualAccount,
        clearingAccount: duplicateAccount.clearingAccount,
        suspenseAccount: duplicateAccount.suspenseAccount,
