...
export const FORM_REQUIREMENTS: FormRequirementsMap = {
  ...
  chartOfAccountCreate: {
    ...
    cashFlowCategory: false,
      ...
      monetaryClassification: false,
      translationTreatment: false,
  ...
  priceLevelCreate: {
    ...
    subsidiaryId: false,
    includeChildren: false,
    defaultDiscountPct: false,
    minimumMarginPct: false,
...
export const FORM_LABELS: Record<FormKey, string> = {
  ...
  priceLevelCreate: 'Price Level',
  priceBookCreate: 'Price Book',
  roleCreate: 'Role',
  userCreate: 'User',
}
...
export const FORM_FIELD_LABELS: Record<FormKey, Record<string, string>> = {
  ...
  chartOfAccountCreate: {
    ...
    cashFlowCategory: 'Cash flow category',
      inventory: 'Inventory',
      revalueOpenBalance: 'Remeasure open balance',
      monetaryClassification: 'Monetary classification',
      translationTreatment: 'Translation treatment',
  ...
  priceLevelCreate: {
    ...
    subsidiaryId: 'Subsidiary',
    includeChildren: 'Include Children',
    defaultDiscountPct: 'Default Discount %',
  ...
  priceBookCreate: {
    ...
    includeChildren: 'Include Children',
    currencyId: 'Currency',
    defaultPriceLevelId: 'Default Price Level',
    approvalRequired: 'Approval Required',
    approvalWorkflow: 'Approval Workflow',
    allowManualOverride: 'Allow Manual Override',
    effectiveStartDate: 'Effective Start Date',
