...
export const MASTER_DATA_HEADER_CELL_CLASSNAME =
  'sticky top-0 z-10 px-4 py-2 text-left text-xs font-medium uppercase tracking-wide'
...
export const MASTER_DATA_BODY_CELL_CLASSNAME = 'px-4 py-2 text-sm'

export const MASTER_DATA_MUTED_CELL_STYLE = {
  color: 'var(--text-secondary)',
} as const

export const MASTER_DATA_EMPTY_CELL_CLASSNAME = 'px-4 py-8 text-center text-sm'
